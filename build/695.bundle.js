...
<div class="demo">
  ...
  <sc-editor
    ...
    @change=${e=>async function(e){window.audioContext&&await window.audioContext.close(),window.audioContext=new AudioContext,await window.audioContext.resume(),window.module&&await window.module.exit(),document.querySelector("#mute").value=!1;const n=new File([e+="\nexport function exit() {\n  scheduler.clear();\n}\n"],`module-${parseInt(1e9*Math.random())}.js`,{type:"text/javascript"}),t=URL.createObjectURL(n);window.module=await import(t)}(e.detail.value)}
  ></sc-editor>
